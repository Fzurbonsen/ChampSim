...
typedef struct {
	...
	uint16_t head; // ghb_pointer that holds the head at the time of adding the entry
} ghb_entry_t;
...
typedef struct {
	...
	uint8_t counters[DCT_NUM_CANDIDATES]; // occurrence of following deltas
} dct_entry_t;
```
